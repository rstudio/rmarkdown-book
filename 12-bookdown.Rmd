...
By default, all Rmd files are merged to render the book. The `index.Rmd` file is the first file when merging all Rmd files. You should only specify the YAML metadata in this file, e.g.,
