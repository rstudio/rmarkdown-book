...
The **rticles** package [@R-rticles]\index{rticles package} is designed to simplify the creation of documents that conform to submission standards. A suite of custom R Markdown templates for popular journals are provided by the package such as those shown in Figure \@ref(rticles-templates).
