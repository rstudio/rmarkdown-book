...
Most output formats introduced in this book are created and maintained by the RStudio team. In fact, other members in the R community\index{R community} have also created a number of R Markdown output formats. We mention those formats that we are aware of in this chapter. If you have developed or know other formats, please feel free to suggest us add them to the page https://rmarkdown.rstudio.com/formats.html.
...
Shower (https://github.com/shower/shower) is a popular and customizable HTML5 presentation framework. See Figure \@ref(fig:shower) for what it looks like.
